			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Add Teachers</h1>
					</div>
							...
							<div class="col-sm-12 col-md-6 ">
								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<h6 class="card-subtitle mb-2 text-muted">Sample Data</h6>
										<div class="canvas-wrapper">
											<canvas class="chart" id="pie-chart" height="300" width="600"></canvas>
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-12 col-md-6">
								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<h6 class="card-subtitle mb-2 text-muted">Sample Data</h6>
										<div class="canvas-wrapper">
											<canvas class="chart" id="polar-area-chart" height="300" width="600"></canvas>
										</div>
									</div>
								</div>
							</div>
