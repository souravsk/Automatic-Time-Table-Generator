			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				...
				<section class="row">
                                    ...
                                    <div class="card-block">
										...
										<!--form class="form" action="#">
											<div class="form-group row">
												<label class="col-md-3 col-form-label">SELECT YOUR SUBJECT</label>
												 <form class="form">
												<div class="col-md-9">
                    <?php
    
                    $mysqli=new mysqli('localhost','root','','table') or die(mysqli_error($mysqli));
                    $result=$mysqli->query("SELECT * FROM teach")or die($mysqli->error);
                    ...
                    <?php 
                          ...
                          {
        		     ?>
				             <option value="<?php $depart=$row['subjects']; ?>"><?php  echo $row['subjects']; ?></option>
                    ...
                    <?php     
        		     ...
        		     ?>                                    
                                    ...
                                    <label class="col-md-3 col-form-label">Available Teachers : </label><br>
                                    <?php
    
                    $mysqli=new mysqli('localhost','root','','table') or die(mysqli_error($mysqli));
                    $result=$mysqli->query("SELECT name FROM teach WHERE subjects not like('CEL 207 - Surveying I')")or die($mysqli->error);
                    if (mysqli_num_rows($result) > 0) 
                       {
                         // output data of each row  ?>                                 
                    ...
                    <?php 
                          ...
                          {
        		     ?>      
				             <option value="<?php $depart=$row['name']; ?>"><?php  echo $row['name']; ?></option>
