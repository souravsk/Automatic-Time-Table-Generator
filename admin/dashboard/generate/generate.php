<?php
   ...
   $mysqli->query("TRUNCATE TABLE generate") or 
              die($mysqli->error);
...
<?php
  $mysqli = new Mysqli("localhost","root","","table");
 $result=  $mysqli->query("select count(p1) as Count from generate where p1='$a'") or 
              die($mysqli->error);
...
<div class="container" id="mainpage" style="text-align:center">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td colspan="2"><?php echo $m1." ".$m2?></td>
            <?php
              $mysqli = new Mysqli("localhost","root","","table");
              $mysqli->query("INSERT INTO generate (day,p1,p2,p3,p4,p5,p6,p7) VALUES('Mon','$c','$a','$b','$h','--','$m1','$m2')") or 
              die($mysqli->error);
        ...
        <tr>
            ...
            <td colspan="2"><?php echo $t1." ".$t2 ?></td>
            <?php
              $mysqli = new Mysqli("localhost","root","","table");
              $mysqli->query("INSERT INTO generate (day,p1,p2,p3,p4,p5,p6,p7) VALUES('Tue','$a','$c','$d','$e','--','$t1','$t2')") or 
              die($mysqli->error);
        ...
        <tr>
            ...
            <td colspan="2"><?php echo $w1." ".$w2 ?></td>
            <?php
              $mysqli = new Mysqli("localhost","root","","table");
              $mysqli->query("INSERT INTO generate (day,p1,p2,p3,p4,p5,p6,p7) VALUES('wed','$d','$a','$b','$e','--','$w1','$w2')") or 
              die($mysqli->error);
        ...
        <tr>
            ...
            <td colspan="2"><?php echo $tr1." ".$tr2?></td>
            <?php
              $mysqli = new Mysqli("localhost","root","","table");
              $mysqli->query("INSERT INTO generate (day,p1,p2,p3,p4,p5,p6,p7) VALUES('Thur','$b','$g','$h','$c','--','$tr1','$tr2')") or 
              die($mysqli->error);
        ...
        <tr>
            ...
            <td colspan="2"><?php echo $f1." ".$f2?></td>
            <?php
              $mysqli = new Mysqli("localhost","root","","table");
              $mysqli->query("INSERT INTO generate (day,p1,p2,p3,p4,p5,p6,p7) VALUES('Fri','$a','$g','$h','$f','--','$f1','$f2')") or 
              die($mysqli->error);
...
<div class="container">
    ...
    <div id="generatebutton">
        <a href=""  onclick="return xepOnline.Formatter.Format('mainpage',{render:'newwin', pageWidth:'350mm', pageHeight:'210mm', mimeType:'image/jpg'});  ">
            <button  class="btn btn-info ">Download  JPG</button>
        </a>
