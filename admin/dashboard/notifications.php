		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="notifications.php"><em class="fa fa-bell"></em> Workload <span class="sr-only">(current)</span></a></li>
				</ul>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Workload</h1>
					</div>
				...
				<section class="row">
                    ...
                    $mysqli=new mysqli('localhost','root','','table') or die(mysqli_error($mysqli));
                    $result=$mysqli->query("SELECT * FROM loadw")or die($mysqli->error);
                    if (mysqli_num_rows($result) > 0) {
                       // output data of each row
                    ?>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <div class="progress progress-custom">
                                                                <div class="progress-bar bg-primary" style="width:<?php  echo ($row['total'])*11; ?><?php echo "%" ?>" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><br><br>
                                                                </div>
                                                            </div>
                                                        </td>
